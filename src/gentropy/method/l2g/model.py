...
class L2GModelWrapper:
    ...
    # default_label_encoder = {"negative": 0, "positive": 0}

    def __init__(
        self,
        # features_list: Sequence[L2GFeatureName],
        hyperparameters: dict[str, int | float | str],
        # features: L2GFeatureMatrix,
        ...
        # self.label_encoder = label_encoder or self.default_label_encoder
...
class L2GDataHandler:
    @classmethod
    def label(cls):
        pass

    @classmethod
    def split(cls, feature_matrix: L2GFeatureMatrix) -> DataSplit:
        feature_matrix._df.toPandas()

    # def predict(
    #     self: LocusToGeneModelWrapper,
    ...
    # @classmethod
    # def from_disk(
    #     cls: type[LocusToGeneModelWrapper],
    #     session: Session,
    #     path: str,
